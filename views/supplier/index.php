...
$this->params['create'] = Html::a('Create Supplier', ['create'], ['class' => 'btn btn-primary']);
$this->title = 'Suppliers';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="supplier-index ibox float-e-margins ibox-content">
    ...
    <?= Html::a('<i class="fa fa-print"></i> Print Suppliers', 
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            ['label' => 'TELEPHONE', 'attribute' => 'telephone'],
            
            ['label' => 'ADDRESS', 'attribute' => 'address', 'value' => function($model) {
